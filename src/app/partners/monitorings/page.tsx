    ...
    <div className="container">
      <Breadcrumbs
        pages={[
          ...
          { name: "Мониторингам", href: "/monitoring" },
        ]}
      />
      <section className="form-cont">
        <div className="form-photo">
          <div className="form__text">
            ...
            <p className="form-photo-text">
              Для участия в партнёрской программе, зарегистрируйтесь как
              мониторинг на нашем сайте, и получите реферальную ссылку.{" "}
            </p>
