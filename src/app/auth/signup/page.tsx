    ...
    <div className="container">
            <section className="form-cont">
                <div className="form-photo">
                    <Image alt="back" width={272.8480224609375} height={349.6862487792969} className="form-main-img" src="/backgrounds/auth.png"/>
                    <Image alt="back" width={59.40430884689809} height={73.59034794388808} className="form-token" src="/backgrounds/token.png"/>
                </div>
                <div className="form-body">
                    <form id="registrationForm">
                        ...
                        <p>Зарегистрировавшись, вы соглашаетесь с <a className="form-link" href="#">Условиями обслуживания</a> и <a className="form-link" href="#">Политикой конфиденциальности</a> Azazex.</p>
                        <span>Уже есть аккаунт? <a className="form-link-main" href="/auth/login">Войти</a></span>
                        <button className="form-body-button" type="submit">Зарегистрироваться</button>
