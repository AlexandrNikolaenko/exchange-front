      ...
      <ol className={`info-list-sub ${isOpen ? "" : "hide"} `}>
        <li>
          ...
          <p>
            ...
            nisi qui sed quo blanditiis possimus fugiat laborum iusto, quisquam
            magnam praesentium quasi error dignissimos.
          </p>
        </li>
        <li>
          <span> Azazex (&quot;Сервис&quot;)</span>
